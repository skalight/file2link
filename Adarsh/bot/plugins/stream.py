...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        dulink = await https://shorturllink.in/api?api=e0867ce24e2238645541bf7651be2217b4cd5dd1&url=f"{Var.URL}{quote_plus(get_name(log_msg))}/{str(log_msg.message_id)}?hash={get_hash(log_msg)}"&alias=filetodub&format=text
        parse_mode="HTML"
        print(dulink)
